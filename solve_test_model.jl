...
κ[3] = 2.3e7*1e-9
κ[4] = 3.1e-3
κ[5] = 4.3e-3 #Anand* - indicates where i got the value from, * indicates that i'm not convinced with the values because it wasnt the exact same reaction
κ[6] = 2.4e-3 #Anand*
κ[7] = 0.9 #Anand*
...
κ[39] = 0.26 #Varner et al.
κ[40] = 4e8*1e-9
κ[41] = 0.2
κ[42] = 1e8*1e-9
κ[43] = 103
κ[44] = 63.5
κ[45] = 0.1 #Varner et al.*
κ[46] = 1 #Varner et al.*
κ[47] = 4.3e-2 #Varner et al.*
κ[48] = 9e5*1e-9
κ[49] = 3.6e-4
κ[50] = 3.2e8
κ[51] = 1.1e-4
